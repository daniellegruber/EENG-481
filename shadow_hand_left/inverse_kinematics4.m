...
thumbRestingFinger = {'RF'}; % which finger thumb rests upon, e.g., MF in number 1 and RF in number 2
...
if fingerIdx == 5 % Thumb
    ...
    tip_pos.OrientationTolerance = deg2rad(20); % allow more leeway for orientation
