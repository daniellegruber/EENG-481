...
yoffset_from_palm = [0.01, -0.01, 0.01, 0.01];
...
if fingerIdx == 5 % Thumb
    ...
    elseif any(contains(thumbTouchesFinger, fingerNames{fingerIdx}))
        ...
        trvec_knuckle = trvec(knuckle_to_world); 
        trvec_new = trvec_palm;
        trvec_new(1) = trvec_palm(1) + 0.08; 
        trvec_new(2) = trvec_palm(2)+ yoffset_from_palm(fingerIdx);
        trvec_new(3) = trvec_knuckle(3) + zoffset_from_knuckle(fingerIdx);
        T1 = se3(trvec_new, "trvec");
