...
wb = load_workbook("C:/Users/joela/Downloads/Senior_Project/joint_angle_data_1-10.xlsx")
ws = wb.active
...
while True:
    ...
    if key != 255:
        ...
        keypress = chr(key)
        angles = [angle_thumb_cmc,angle_thumb_mcp,angle_thumb_sip,angle_index_mcp,angle_index_pip,angle_index_dip,angle_middle_mcp,
                  angle_middle_pip,angle_middle_dip,angle_ring_mcp,angle_ring_pip,angle_ring_dip,angle_pinky_mcp,angle_pinky_dip,angle_pinky_pip]
        # print(angles)
        # print(len(angles))
        row_data = [keypress] + angles

        # Append a new row to the worksheet
        ws.append(row_data)

        # Save the workbook (can do it each time or once after the loop).
        wb.save("C:/Users/joela/Downloads/Senior_Project/joint_angle_data_1-10.xlsx")
        print(keypress,angles)
    if key == ord('q'):
        break
