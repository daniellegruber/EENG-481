...
%% Letter u -> something
toLetter = 'w';
[ds1, qInterp] = genConfigTrajectoryNoInterferenceAvodiance({'letter_u', ['letter_', toLetter]}, jointNames);
% [ds1, qInterp] = genConfigTrajectoryNoInterferenceAvodiance({'letter_u', 'letter_z_stage_1'}, jointNames);
...
[ds2, ~] = genConfigTrajectoryNoInterferenceAvodiance({'letter_u', ['transition_u_to_', toLetter], ['letter_', toLetter]}, jointNames);
