...
%% Letter u -> something
toLetter = 'w';
[ds1, qInterp] = genConfigTrajectoryNoInterferenceAvoidance({'letter_u', ['letter_', toLetter]}, jointNames);
% [ds1, qInterp] = genConfigTrajectoryNoInterferenceAvoidance({'letter_u', 'letter_z_stage_1'}, jointNames);
...
%% Letter u -> something adjustments
...
save(['Configs', filesep, 'transition_u_to_', toLetter, '.mat'], "jointValues");
...
[ds2, ~] = genConfigTrajectoryNoInterferenceAvoidance({'letter_u', ['transition_u_to_', toLetter], ['letter_', toLetter]}, jointNames);
