...
%% Letter r -> something
toLetter = 'z';
%[ds1, qInterp] = genConfigTrajectoryNoInterferenceAvodiance({'letter_r', ['letter_', toLetter]}, jointNames);
[ds1, qInterp] = genConfigTrajectoryNoInterferenceAvodiance({'letter_r', 'letter_z_stage_1'}, jointNames);
...
[ds2, ~] = genConfigTrajectoryNoInterferenceAvodiance({'letter_r', ['transition_r_to_', toLetter], ['letter_', toLetter]}, jointNames);
