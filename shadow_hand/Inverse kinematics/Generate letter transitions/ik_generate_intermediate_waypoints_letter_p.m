...
toLetter = 'y';
[ds1, qInterp] = genConfigTrajectoryNoInterferenceAvoidance({'letter_p', ['letter_', toLetter]}, jointNames);
...
%%
[ds2, ~] = genConfigTrajectoryNoInterferenceAvoidance({'letter_p', ['transition_p_to_', toLetter], ['letter_', toLetter]}, jointNames);
