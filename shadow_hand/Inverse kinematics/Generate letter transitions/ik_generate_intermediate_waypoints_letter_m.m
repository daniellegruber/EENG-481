...
%% Letter m -> something
toLetter = 'y';
[ds1, qInterp] = genConfigTrajectoryNoInterferenceAvoidance({'letter_m', ['letter_', toLetter]}, jointNames);
% [ds1, qInterp] = genConfigTrajectoryNoInterferenceAvoidance({'letter_m', 'letter_z_stage_1'}, jointNames);
...
%% Letter m -> something adjustments
...
save(['Configs', filesep, 'transition_m_to_', toLetter, '.mat'], "jointValues");
...
[ds2, ~] = genConfigTrajectoryNoInterferenceAvoidance({'letter_m', ['transition_m_to_', toLetter], ['letter_', toLetter]}, jointNames);

supplyInputToUserInputMdlByDs(mdl, ds2);
pause(8);

%% Letter k -> something (multiple fingers problematic)
