...
x_offset = {[0 0 0.02 0 0], [0 0 0.02 0 0]};
y_offset = {[0 0 0 0 0.01], [0 0 0 0 0.03]};
z_offset = {[0 0 0.02 0 -0.01], [0 0 0.02 0 0]};
...
for i = 1:length(intermediatePointProp)
    ...
    save(['Configs', filesep, 'transition_n_to_z_', num2str(i), '.mat'], "jointValues");
