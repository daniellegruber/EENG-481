...
%% Letter k -> something
toLetter = 'y';
[ds1, qInterp] = genConfigTrajectoryNoInterferenceAvoidance({'letter_k', ['letter_', toLetter]}, jointNames);
% [ds1, qInterp] = genConfigTrajectoryNoInterferenceAvoidance({'letter_k', 'letter_z_stage_1'}, jointNames);
...
%% Letter k -> something adjustments
...
save(['Configs', filesep, 'transition_k_to_', toLetter, '.mat'], "jointValues");
...
[ds2, ~] = genConfigTrajectoryNoInterferenceAvoidance({'letter_k', ['transition_k_to_', toLetter], ['letter_', toLetter]}, jointNames);
