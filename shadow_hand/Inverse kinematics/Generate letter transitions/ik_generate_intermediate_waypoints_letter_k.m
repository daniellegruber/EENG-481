...
%% Letter k -> something
toLetter = 'y';
[ds1, qInterp] = genConfigTrajectoryNoInterferenceAvodiance({'letter_k', ['letter_', toLetter]}, jointNames);
% [ds1, qInterp] = genConfigTrajectoryNoInterferenceAvodiance({'letter_k', 'letter_z_stage_1'}, jointNames);
...
[ds2, ~] = genConfigTrajectoryNoInterferenceAvodiance({'letter_k', ['transition_k_to_', toLetter], ['letter_', toLetter]}, jointNames);
