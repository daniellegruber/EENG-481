...
%% Letter z -> something
toLetter = 'a';
[ds1, qInterp] = genConfigTrajectoryNoInterferenceAvodiance({'letter_z_stage_4', ['letter_', toLetter]}, jointNames);
% [ds1, qInterp] = genConfigTrajectoryNoInterferenceAvodiance({'letter_z_stage_4', 'letter_z_stage_1'}, jointNames);
...
save(['Configs', filesep, 'transition_z_to_', toLetter, '.mat'], "jointValues");
...
[ds2, ~] = genConfigTrajectoryNoInterferenceAvodiance({'letter_z_stage_4', ['transition_z_to_', toLetter], ['letter_', toLetter]}, jointNames);
