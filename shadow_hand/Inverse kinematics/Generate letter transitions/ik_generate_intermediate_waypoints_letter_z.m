...
%% Letter z -> something
toLetter = 'u';
[ds1, qInterp] = genConfigTrajectoryNoInterferenceAvoidance({'letter_z_stage_4', ['letter_', toLetter]}, jointNames);
% [ds1, qInterp] = genConfigTrajectoryNoInterferenceAvoidance({'letter_z_stage_4', 'letter_z_stage_1'}, jointNames);
...
[ds2, ~] = genConfigTrajectoryNoInterferenceAvoidance({'letter_z_stage_4', ['transition_z_to_', toLetter], ['letter_', toLetter]}, jointNames);
